...
class TodoAdapterUncompleted: RecyclerView.Adapter<TodoAdapterUncompleted.TodoViewHolderUncompleted>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodoViewHolderUncompleted = TodoViewHolderUncompleted(
    ...
    override fun onBindViewHolder(holder: TodoViewHolderUncompleted, position: Int) {
    ...
    class TodoViewHolderUncompleted(var view: View): RecyclerView.ViewHolder(view){
