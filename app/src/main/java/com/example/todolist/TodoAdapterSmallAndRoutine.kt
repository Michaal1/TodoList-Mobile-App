...
class TodoAdapterSmallAndRoutine: RecyclerView.Adapter<TodoAdapterSmallAndRoutine.TodoViewHolderSmallAndRoutine>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodoViewHolderSmallAndRoutine = TodoViewHolderSmallAndRoutine(
    ...
    override fun onBindViewHolder(holder: TodoViewHolderSmallAndRoutine, position: Int) {
    ...
    class TodoViewHolderSmallAndRoutine(var view: View): RecyclerView.ViewHolder(view){
