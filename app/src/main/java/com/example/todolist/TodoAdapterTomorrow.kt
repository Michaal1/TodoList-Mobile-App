...
class TodoAdapterTomorrow: RecyclerView.Adapter<TodoAdapterTomorrow.TodoViewHolderTomorrow>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodoViewHolderTomorrow = TodoViewHolderTomorrow(
    ...
    override fun onBindViewHolder(holder: TodoViewHolderTomorrow, position: Int) {
    ...
    class TodoViewHolderTomorrow(var view: View): RecyclerView.ViewHolder(view){
